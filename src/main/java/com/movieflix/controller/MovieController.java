...
import com.movieflix.exceptions.FileEmptyException;
...
public class MovieController {
    ...
    public ResponseEntity<MovieDto> addMovieHandler(@RequestPart MultipartFile file,
                                                    @RequestPart String movieDto) throws IOException, FileAlreadyExistingException, FileEmptyException {
        if(file.isEmpty()){
            throw new FileEmptyException("File is Empty , Please add an file ");
        }
    ...
    public ResponseEntity<String> deleteMovieHandler(@PathVariable Integer movieId) throws IOException, MovieNotFoundException {
